...
const MenuBuilder = () => {
  ...
  const [expandedCategories, setExpandedCategories] = useState<Set<string>>(
    new Set(["sweets", "snacks", "main-course"]),
  );
  ...
  const morningMenu: MenuCategory[] = [
      ...
      items: [
        {
          id: "carrot-halwa",
          name: "Carrot Halwa",
          nameTamil: "கேரட் மைசூர்பா",
        },
        { id: "mini-laddu", name: "Mini Laddu", nameTamil: "மினி லட்டு" },
        {
          id: "kadalai-paruppu-halwa",
          name: "Kadalai Paruppu Halwa",
          nameTamil: "கடலைப்பருப்பு+பழம்+நெய்",
        },
        {
          id: "badam-halwa",
          name: "Badam Halwa",
          nameTamil: "தேங்காய் ஒப்பிட்டு",
        },
        { id: "mini-jilebi", name: "Mini Jilebi", nameTamil: "மினி ஜிலேபி" },
        {
          id: "mini-mysurpa",
          name: "Mini Mysurpa",
          nameTamil: "மினி மைசூர்பா",
        },
        {
          id: "kodumai-halwa",
          name: "Kodumai Halwa",
          nameTamil: "கோதுமை அல்வா",
        },
        { id: "puri-halwa", name: "Poori Halwa", nameTamil: "பூரி அல்வா" },
        {
          id: "carrot-halwa-kesari",
          name: "Carrot Kesari",
          nameTamil: "கேரட் கேசரி",
        },
        { id: "rava-kesari", name: "Rava Kesari", nameTamil: "ரவா கேசரி" },
        {
          id: "pineapple-kesari",
          name: "Pineapple Kesari",
          nameTamil: "அன்னாசி கேசரி",
        },
      ],
    },
    {
      ...
      items: [
        { id: "poori", name: "Poori", nameTamil: "பூரி" },
        {
          id: "mini-chapathi",
          name: "Mini Chapathi",
          nameTamil: "மினி சப்பாத்தி",
        },
        { id: "mini-parotta", name: "Mini Parotta", nameTamil: "மினி பரோட்டா" },
        {
          id: "mini-parotta-dip",
          name: "Mini Parotta Dip",
          nameTamil: "மினி பரோட்டா டிப்",
        },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "veg-idli", name: "Veg Idli", nameTamil: "வெஜ் இட்லி" },
        {
          id: "malliga-idli",
          name: "Malliga Idli",
          nameTamil: "மல்லிகை இட்லி",
        },
        {
          id: "mini-sambar-idli",
          name: "Mini Sambar Idli",
          nameTamil: "மினி சாம்பார் இட்லி",
        },
        ...
        { id: "masala-dosa", name: "Masala Dosa", nameTamil: "மசாலா தோசை" },
        {
          ...
          nameTamil: "ஆனியன் ரவா தோசை",
        },
        {
          id: "mysore-masala-dosa",
          name: "Mysore Masala Dosa",
          nameTamil: "மைசூர் மசாலா தோசை",
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: "thakkali-kolambu",
          name: "Thakkali Kolambu",
          nameTamil: "தக்காளி கூட்டு",
        },
        {
          id: "poondu-kolambu",
          name: "Poondu Kolambu",
          nameTamil: "பூண்டு கூட்டு",
        },
        {
          id: "thakkali-gothsu",
          name: "Thakkali Gothsu",
          nameTamil: "தக்காளிகொத்சு",
        },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "aloo-gobi", name: "Aloo Gobi", nameTamil: "உருளை-கோபி" },
        {
          ...
          nameTamil: "மிக்ஸ்ட் வெஜ்",
        },
        {
          id: "channa-masala",
          name: "Channa Masala",
          nameTamil: "சன்னா மசாலா",
        },
        {
          id: "kadai-paneer",
          name: "Kadai Paneer",
          nameTamil: "கடாய் பன்னீர்",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          id: "onion-chutney",
          name: "Onion Chutney",
          nameTamil: "வெங்காய சட்னி",
        },
        {
          id: "pudina-chutney",
          name: "Pudina Chutney",
          nameTamil: "புதினா சட்னி",
        },
        {
          id: "mango-pickle",
          name: "Mango Pickle",
      ...
      items: [
        {
          ...
          nameTamil: "பருப்பு பாயாசம்",
        },
        {
          id: "ada-pradhaman",
          name: "Ada Pradhaman",
          nameTamil: "அடை பிரதமன்",
        },
        {
          id: "javvarisi-payasam",
          name: "Javvarisi Payasam",
          nameTamil: "ஜவ்வரிசி பாயாசம்",
        },
        {
          id: "kodumai-payasam",
          name: "Wheat Payasam",
          nameTamil: "கோதுமை பாயாசம்",
        },
        {
          id: "badam-payasam",
          name: "Badam Payasam",
          nameTamil: "பாதாம் பாயசம்",
        },
        { id: "pal-payasam", name: "Pal Payasam", nameTamil: "பால் பாயசம்" },
        {
          id: "sakkarai-payasam",
          name: "Sakkarai Payasam",
          nameTamil: "சர்க்கரை பாயசம்",
        },
        {
          id: "semiya-payasam",
          name: "Semiya Payasam",
          nameTamil: "சேமியா பாயசம்",
        },
      ],
    },
    {
  ...
  const eveningMenu: MenuCategory[] = [
      ...
      items: [
        {
          id: "ev-horlicks-pori",
          name: "Horlicks Pori",
          nameTamil: "ஹார்லிக்ஸ் பொரி",
        },
        {
          id: "ev-strawberry-pori",
          name: "Strawberry Pori",
          nameTamil: "ஸ்ட்ராபெரி பொரி",
        },
        { id: "ev-angurpuli", name: "Angur Puli", nameTamil: "அங்கூர்புலி" },
        {
          id: "ev-malabar-sandwich",
          name: "Malabar Sandwich",
          nameTamil: "மலபார் சாண்ட்விச்",
        },
        { id: "ev-badam-rose", name: "Badam Rose", nameTamil: "பாதாம் ரோஸ்" },
        {
          id: "ev-mango-kesari",
          name: "Mango Kesari",
          nameTamil: "மாங்காய் கேசரி",
        },
        {
          id: "ev-pineapple-kesari",
          name: "Pineapple Kesari",
          nameTamil: "அன்னாசி கேசரி",
        },
        {
    ...
    },
    {
      ...
      items: [
        {
          id: "st-veg-spring-roll",
          name: "Veg Spring Roll",
          nameTamil: "வெஜ் ஸ்பிரிங்ரோல்",
        },
        {
          id: "st-mushroom-spring-roll",
          name: "Mushroom Spring Roll",
          nameTamil: "மஷ்ரூம் ஸ்பிரிங்ரோல்",
        },
        { id: "st-veg-cutlet", name: "Veg Cutlet", nameTamil: "வெஜ் கட்லட்" },
        {
          id: "st-paneer-cutlet",
          name: "Paneer Cutlet",
          nameTamil: "பன்னீர் கட்லட்",
        },
        {
          id: "st-mushroom-cutlet",
          name: "Mushroom Cutlet",
          nameTamil: "மஷ்ரூம் கட்லட்",
        },
        {
          id: "st-corn-cutlet",
          name: "Corn Cutlet",
          nameTamil: "கார்ன் கட்லட்",
        },
        {
          id: "st-american-corn",
          name: "American Corn",
          nameTamil: "அமெரிக்கன் கார்ன்",
        },
        { id: "st-cheese-roll", name: "Cheese Roll", nameTamil: "சீஸ் ரோல்" },
        {
          id: "st-paneer-samosa",
          name: "Paneer Samosa",
          nameTamil: "பன்னீர் சமோசா",
        },
        {
          id: "st-aniyan-samosa",
          name: "Onion Samosa",
          nameTamil: "ஆனியன் சமோசா",
        },
        {
          id: "st-cocktail-samosa",
          name: "Cocktail Samosa",
          nameTamil: "காக்டெயில் சமோசா",
        },
        {
          id: "st-mayonaise-bonda",
          name: "Mayonaise Bonda",
          nameTamil: "மயோனைஸ் போண்டா",
        },
        {
          id: "st-mundiri-bonda",
          name: "Mundiri Bonda",
          nameTamil: "முந்திரி போண்டா",
        },
        {
          id: "st-cheese-balls",
          name: "Cheese Balls",
          nameTamil: "சீஸ் பால்ஸ்",
        },
      ],
    },
    {
      ...
      items: [
        {
          id: "ss-peppers-chilli",
          name: "Peppers Chilli",
          nameTamil: "பேப்பர்ஸ் சில்லி",
        },
        {
          id: "ss-kovaikkai-chilli",
          name: "Kovaikkai Chilli",
          nameTamil: "கோவக்காய் சில்லி",
        },
        {
          id: "ss-pudalangkai-chilli",
          name: "Pudalangkai Chilli",
          nameTamil: "புடலங்காய் சில்லி",
        },
        {
          id: "ss-mushroom-chilli",
          name: "Mushroom Chilli",
          nameTamil: "மஷ்ரூம் சில்லி",
        },
        {
          id: "ss-paneer-chilli",
          name: "Paneer Chilli",
          nameTamil: "பன்னீர் சில்லி",
        },
        {
          id: "ss-karivepilai-chilli",
          name: "Karivepilai Chilli",
          nameTamil: "கறிவேப்பிலை சில்லி",
        },
    ...
    },
    {
      ...
      items: [
        {
          id: "dip-thakkali-sauce",
          name: "Thakkali Sauce",
          nameTamil: "தக்காளி சாஸ்",
        },
        {
          id: "dip-hot-garlic",
          name: "Hot & Garlic Sauce",
          nameTamil: "ஹாட் கார்லிக் சாஸ்",
        },
      ],
    },
    {
      ...
      items: [
        ...
        { id: "p-pattar-naan", name: "Pattar Naan", nameTamil: "பட்டர் நான்" },
        {
          id: "p-spinach-kulcha",
          name: "Spinach Kulcha",
          nameTamil: "ஸ்பினச் குல்ச்சா",
        },
        {
          id: "p-mini-parotta",
          name: "Mini Parotta",
          nameTamil: "மினி பரோட்டா",
        },
        {
          id: "p-chilli-parotta",
          name: "Chilli Parotta",
        ...
        },
        {
          id: "p-methi-sappathi",
          name: "Methi Sappathi",
          nameTamil: "மெத்தி சப்பாத்தி",
        },
        {
          id: "p-masala-sappathi",
          name: "Masala Sappathi",
          nameTamil: "மசாலா சப்பாத்தி",
        },
        {
          id: "p-aloo-sappathi",
          name: "Aloo Sappathi",
          nameTamil: "ஆலு சப்பாத்தி",
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: "k-navrathina-kuruma",
          name: "Navrathina Kuruma",
          nameTamil: "நவரத்தின குருமா",
        },
        {
          id: "k-pattir-paneer",
          name: "Pattir Paneer Kuruma",
          nameTamil: "பட்டர் பன்னீர் குருமா",
        },
        {
          id: "k-mushrum-kuruma",
          name: "Mushroom Kuruma",
          nameTamil: "மஷ்ரூம் குருமா",
        },
        { id: "k-aloo-kuruma", name: "Aloo Kuruma", nameTamil: "ஆலு குருமா" },
        {
          id: "k-channa-kuruma",
          name: "Channa Kuruma",
          nameTamil: "சன்னா குருமா",
        },
      ...
      items: [
        {
          id: "dk-vatha-kolambu",
          name: "Vatha Kolambu",
          nameTamil: "வத்த கூழம்பு",
        },
        {
          id: "dk-poondu-kolambu",
          name: "Poondu Kolambu",
          nameTamil: "பூண்டு கூழம்பு",
        },
        {
          id: "dk-kathirikai-kolambu",
          name: "Kathirikai Kolambu",
          nameTamil: "கத்திரிக்காய் கூழம்பு",
        },
        {
          id: "dk-vendaikai-kolambu",
          name: "Vendaikai Kolambu",
          nameTamil: "வெண்டைக்காய் கூழம்பு",
        },
      ],
    },
    {
      ...
      items: [
        {
          id: "r-thakkali-rasam",
          name: "Thakkali Rasam",
          nameTamil: "தக்காளி ரசம்",
        },
        {
          id: "r-paneer-rasam",
          name: "Paneer Rasam",
          nameTamil: "மைசூர் ரசம்",
        },
        {
          id: "r-thakkali-rasam-2",
          name: "Thakkali Pepper Rasam",
          nameTamil: "தக்காளி ரசம்",
        },
        { id: "r-milagu-rasam", name: "Milagu Rasam", nameTamil: "மிளகு ரசம்" },
        {
          id: "r-kothamalli-rasam",
          name: "Kothamalli Rasam",
          nameTamil: "கொத்தமல்லி ரசம்",
        },
        {
          id: "r-pineapple-rasam",
          name: "Pineapple Rasam",
          nameTamil: "அன்னாசி ரசம்",
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          id: "po-kothala-poriyal",
          name: "Kothala Poriyal",
          nameTamil: "கத்தரி பொரியல்",
        },
      ],
    },
    {
      ...
      items: [
        {
          id: "dko-poonai-kootu",
          name: "Poonai Kootu",
          nameTamil: "பூசணி கூட்டு",
        },
        {
          id: "dko-pudalangkai-kootu",
          name: "Pudalangkai Kootu",
          nameTamil: "புடலங்காய் கூட்டு",
        },
        {
          id: "dko-morakkai-kootu",
          name: "Morakkai Kootu",
          nameTamil: "மொரக்காய் கூட்டு",
        },
        {
          id: "dko-senai-kilangu",
          name: "Senai Kilangu",
          nameTamil: "சேனை கிழங்கு",
        },
        {
          id: "dko-vazhaikkai-kootu",
          name: "Vazhaikkai Kootu",
          nameTamil: "வாழைக்காய் கூட்டு",
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          id: "vd-thattapairu",
          name: "Thattapairu Vadai",
          nameTamil: "தட்டப்பாயிறு",
        },
        {
          id: "vd-senai-kilangu",
          name: "Senai Kilangu Vadai",
          nameTamil: "சேனை கிழங்கு",
        },
      ],
    },
    {
      ...
      items: [
        {
          id: "pd-pasiparupu",
          name: "Pasiparupu Payasam",
          nameTamil: "பாசிப்பருப்பு",
        },
        {
          id: "pd-pacharisi",
          name: "Pacharisi Payasam",
          nameTamil: "பச்சரிசி",
        },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "eb-water-500", name: "Water 500ml", nameTamil: "தண்ணீர் 500ml" },
        {
          id: "eb-water-20l",
          name: "Water 20L Can",
          nameTamil: "தண்ணீர் 20லிட்டர் கேன்",
        },
      ],
    },
    {
      ...
      items: [
        {
          id: "sn-valaikai-bajji",
          name: "Vazhaikkai Bajji",
          nameTamil: "வாழைக்காய் பஜ்ஜி",
        },
        {
          id: "sn-vengaya-pakoda",
          name: "Vengaya Pakoda",
          nameTamil: "வெங்காய பக்கோடா",
        },
        {
          id: "sn-masala-bonda",
          name: "Masala Bonda",
          nameTamil: "மசாலா போண்டா",
        },
        {
          id: "sn-maisur-bonda",
          name: "Maisur Bonda",
          nameTamil: "மைசூர் போண்டா",
        },
        {
          id: "sn-aniyan-samosa",
          name: "Onion Samosa",
        ...
        { id: "sn-coffee", name: "Coffee", nameTamil: "காபி" },
        {
          id: "sn-welcom-drink",
          name: "Welcome Drink",
          nameTamil: "வெல்கம் ட்ரிங்க்",
        },
        {
          id: "sn-madayel-kupandar",
          name: "Mocktail",
          nameTamil: "மாக்டெயில் குப்பண்டர்",
        },
      ],
    },
  ];
      ...
      items: [
        {
          id: "af-parupu-poli",
          name: "Parupu Poli",
          nameTamil: "பருப்பு போலி",
        },
        {
          id: "af-thengai-poli",
          name: "Thengai Poli",
          nameTamil: "தேங்காய் போலி",
        },
        {
          id: "af-pineapple-kesari",
          name: "Pineapple Kesari",
          nameTamil: "பைனாப்பிள் கேசரி",
        },
        {
          id: "af-gulab-jamun",
          name: "Gulab Jamun",
        ...
        {
          id: "af-poonikai-halwa",
          name: "Poonikai Halwa",
          nameTamil: "பூசணிக்காய் அல்வா",
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          id: "bir-pasikay-battani",
          name: "Pattani Biryani",
          nameTamil: "பட்டாணி பிரியாணி",
        },
        {
          id: "bir-mushroom-biryani",
          name: "Mushroom Biryani",
          nameTamil: "காளான் பிரியாணி",
        },
        {
          id: "bir-thakkali-biryani",
          name: "Thakkali Biryani",
          nameTamil: "தக்காளி பிரியாணி",
        },
        {
          id: "bir-malli-biryani",
          name: "Malli Biryani",
          nameTamil: "மல்லி பிரியாணி",
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          id: "tp-karaikkai",
          name: "Karaikkai Pachadi",
          nameTamil: "காரைக்காய்",
        },
      ],
    },
    {
      ...
      items: [
        {
          id: "ar-pachchai-arisi",
          name: "Patchai Arisi Sadam",
          nameTamil: "பச்சை அரிசி",
        },
        {
          id: "ar-puzhungal-arisi",
          name: "Puzhungal Arisi",
          nameTamil: "புழுங்கல் அரிசி",
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          id: "par-parsai-parupu",
          name: "Parsai Parupu ",
          nameTamil: "பாசி பருப்பு-நெய்",
        },
        {
          id: "par-kosu-parupu",
          name: "Kosu Parupu",
          nameTamil: "கொஸு பருப்பு-நெய்",
        },
      ],
    },
    {
      ...
      items: [
        {
          id: "as-murungai-sambar",
          name: "Murungai Sambar",
          nameTamil: "முருங்கை+சின்ன வெங்காய சாம்பார்",
        },
        {
          id: "as-malabar-sambar",
          name: "Malabar Sambar",
          nameTamil: "மலபார் சாம்பார்",
        },
        {
          id: "as-navrathina-sambar",
          name: "Navrathina Sambar",
          nameTamil: "நவரத்தின சாம்பார்",
        },
        {
          id: "as-kathiri-urulan-sambar",
          name: "Kathiri Urulan Sambar",
          nameTamil: "கத்திரி உருளை சாம்பார்",
        },
        {
          id: "as-poonikai-sambar",
          name: "Poonikai Sambar",
          nameTamil: "பூசணிக்காய் சாம்பார்",
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          id: "ak-poondu-kolambu",
          name: "Poondu Kolambu",
          nameTamil: "பூண்டு கூழம்பு",
        },
        {
          id: "ak-kathirikai-kolambu",
          name: "Kathirikai Kolambu",
          nameTamil: "கத்திரிக்காய் கூழம்பு",
        },
        {
          id: "ak-vendaikai-kolambu",
          name: "Vendaikai Kolambu",
          nameTamil: "வெண்டைக்காய் கூழம்பு",
        },
      ],
  ...
  const currentMenu =
    mealType === "morning" ? morningMenu : [...eveningMenu, ...afternoonMenu];
  ...
  const generateWhatsAppMessage = () => {
    ...
    allCategories.forEach((category) => {
      const selectedFromCategory = category.items.filter((item) =>
    ...
    window.open(
      `https://wa.me/918760101010?text=${encodeURIComponent(message)}`,
      "_blank",
    );
  };
          ...
          >
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-full text-sm font-medium transition-all ${
                mealType === "morning" ? "text-black" : "text-white/60"
              }`}
              style={{
                background: mealType === "morning" ? "#C9A227" : "transparent",
              }}
            >
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-full text-sm font-medium transition-all ${
                mealType === "evening" ? "text-black" : "text-white/60"
              }`}
              style={{
                background: mealType === "evening" ? "#C9A227" : "transparent",
              }}
            >
                  ...
                  <div className="px-4 pb-4 grid grid-cols-2 md:grid-cols-3 gap-2">
                    {category.items.map((item) => (
                      ...
                      >
                        ...
                        <div
                          className={`${item.id === "kadalai-paruppu-halwa" ? "min-w-0 overflow-hidden break-words text-left" : ""}`}
                        >
              ...
              {selectedItems.size === 0 ? (
                ...
                <>
                  <div className="max-h-[40vh] overflow-y-auto space-y-3 mb-6">
                    {[...morningMenu, ...eveningMenu, ...afternoonMenu].map(
                      (category) => {
                        const selectedFromCategory = category.items.filter(
