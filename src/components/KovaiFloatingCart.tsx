...
/**
 * KovaiFloatingCart component
 * Displays a floating cart icon above the WhatsApp button for Kovai Caterers
 * Shows cart count badge when items are in cart
 */
const KovaiFloatingCart: React.FC = () => {
...
export default KovaiFloatingCart;
