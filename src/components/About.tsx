        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="text-sm text-black/70 tracking-wide uppercase">Weddings Served</div>
            </div>
          </div>
          ...
          <div>
            ...
            >
              Crafting Culinary{' '}
              <span className="italic" style={{ color: '#C9A227' }}>Excellence</span>{' '}
              Since 2008
            </h2>

            <p className="text-white/60 text-lg mb-6 leading-relaxed">
              Sri Nidhi Catering is where food is celebrated. We are the top gourmet
              wedding caterer in Coimbatore, specializing in authentic South Indian and
              Nilgiri-style cuisine.
            </p>

            <p className="text-white/50 mb-10 leading-relaxed">
              From intimate family gatherings to grand destination weddings, we deliver
              exceptional food with impeccable service. Our team of 50+ professionals
              ensures every event is a culinary masterpiece.
            </p>
            ...
            <div className="grid grid-cols-2 gap-6">
              {features.map((feature, i) => (
                <div key={i} className="flex items-center gap-4">
                  ...
                  >
                    <feature.icon className="w-5 h-5" style={{ color: '#C9A227' }} />
                  </div>
                  <div>
