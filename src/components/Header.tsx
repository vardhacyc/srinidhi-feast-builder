        ...
        <div className="container mx-auto flex justify-between items-center text-sm">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span>info@srinidhicatering.com</span>
            </div>
          </div>
          <div className="hidden md:block">
            <span>Coimbatore's Premium Catering Service</span>
          </div>
        </div>
      </div>
      ...
      <nav className="bg-white py-4 px-4">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Srinidhi Catering</h1>
              <p className="text-sm text-gray-600">A Kovai Catering Subsidiary</p>
            </div>
          </div>
