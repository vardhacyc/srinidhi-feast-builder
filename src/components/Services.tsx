import { Utensils, Users, Building, Cake, PartyPopper, Coffee, ArrowRight } from 'lucide-react';
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(to top, rgba(201, 162, 39, 0.3) 0%, transparent 50%)'
                }}
              ></div>
              ...
              <div className="absolute inset-0 p-6 flex flex-col justify-end">
                ...
                >
                  <service.icon className="w-5 h-5" style={{ color: '#C9A227' }} />
                </div>
