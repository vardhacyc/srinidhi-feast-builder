  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        "Sri Nidhi Catering made our wedding reception absolutely memorable. The food was authentic, service was impeccable.",
    },
    {
      ...
      rating: 5,
      comment:
        "Professional service from start to finish. They handled our annual day with 500+ guests effortlessly.",
    },
    {
      ...
      rating: 5,
      comment:
        "The traditional breakfast spread was exactly what we wanted for our griha pravesham. Fresh and delicious!",
    },
    {
      name: "Lakshmi Devi",
      ...
      rating: 5,
      comment:
        "The live dosa counter was a hit! Everyone loved the variety and quality of food.",
    },
  ];
