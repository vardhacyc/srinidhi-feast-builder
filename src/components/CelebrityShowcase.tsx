        ...
        <section className="relative py-24 overflow-hidden bg-[#0A0A0A]">
            <div className="container mx-auto px-4 lg:px-8">
                ...
                <div className="text-center mb-16">
                    ...
                    >
                        Celebrity{' '}
                        <span className="italic" style={{ color: '#C9A227' }}>Events</span>
                    </h2>
                </div>
                ...
                <div className="max-w-5xl mx-auto">
                    <div className="relative group rounded-2xl overflow-hidden">
                        ...
                        <div
                            ...
                            style={{ background: 'linear-gradient(to top, rgba(0,0,0,0.95) 0%, rgba(0,0,0,0.3) 40%, transparent 70%)' }}
                        ></div>
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <span className="text-xs tracking-wide uppercase" style={{ color: '#C9A227' }}>
                            ...
                            <p className="text-white/60 max-w-2xl leading-relaxed">
                                Proud to be the official caterers for Pooja Kannan's traditional Badaga-style wedding
                                in the serene hills of Kotagiri, Ooty. A beautiful celebration of Nilgiri heritage.
                            </p>
                        </div>
                    </div>
                </div>
